...
Vector2 const raylib__Scale(Vector2 const v, float const s)
{
$$anon_Block_15901871329232600808: (void)(0);
    return (Vector2){(v.x * s)vv.ys(v.y * s)};
}

Vector2 const raylib__Add(Vector2 const v, Vector2 const v2)
{
$$anon_Block_12731370710357201570: (void)(0);
    return (Vector2){(v.x + v2.x)vv.yv2v2.y(v.y + v2.y)};
}
...
$$anon_Block_16745735485697338677: (void)(0);
    ...
    goto $$anon_Loop_15572651889598128231_Check;
    $$anon_Loop_15572651889598128231_Start: (void)(0);
    {
$$anon_Block_9569422634429357098: (void)(0);
        float const delta = raylib__GetFrameTime();
        Vector2 const deltaVel = raylib__Scale((Vector2){15, 16}, delta);
        pos = raylib__Add(pos, deltaVel);
...
$$anon_Block_4907636064931205134: (void)(0);
    ...
    $$anon_Loop_15572651889598128231_Check: (void)(0);
    if (!(raylib__WindowShouldClose())) goto $$anon_Loop_15572651889598128231_Start;
    raylib__CloseWindow();
    return 0;
}
