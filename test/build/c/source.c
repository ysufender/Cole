...
$$anon_Block_18097166642412114837: (void)(0);
    ...
    goto $$anon_Loop_13076022316524835480_Check;
    $$anon_Loop_13076022316524835480_Start: (void)(0);
    {
$$anon_Block_9944550705755129845: (void)(0);
        float const delta = raylib__GetFrameTime();
        pos = (Vector2){(pos.x + 15)pospos.y16(pos.y + 16)};
...
$$anon_Block_2604486134261187998: (void)(0);
    ...
    $$anon_Loop_13076022316524835480_Check: (void)(0);
    if (!(raylib__WindowShouldClose())) goto $$anon_Loop_13076022316524835480_Start;
    raylib__CloseWindow();
    return 0;
}
