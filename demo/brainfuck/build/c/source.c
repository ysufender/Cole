...
$$anon_Block_9546729811265229851: (void)(0);
    ...
    $$anon_OptimizedLoop_18097166642412114837: (void)(0);
...
$$anon_Block_4868289067183140247: (void)(0);
        if ((!((!(std__io__file__ok(source)))))) goto $$anon_Finally_13414203536031990682;
        {
$$anon_Block_5408961738284701175: (void)(0);
        ...
        goto $$anon_Finally_13414203536031990682;
        $$anon_Finally_13414203536031990682: (void)(0);
    }

    uint32_t idx = 0;
    int32_t ch = std__io__file__read(source);
    $$anon_OptimizedLoop_16162674634529531010: (void)(0);
    std__io__file__close(source);
    return 1;
}
...
$$anon_Block_2176238421820118170: (void)(0);
    uint32_t count = 1;
    $$anon_OptimizedLoop_16899537894403953799: (void)(0);
}
...
$$anon_Block_13312278519466678316: (void)(0);
    uint32_t count = 1;
    $$anon_OptimizedLoop_8984152290478481302: (void)(0);
}
...
$$anon_Block_779881660930942984: (void)(0);
        if ((!(((*((&((*(cpu)).ip)))) >= (*((&((*(cpu)).bytecode)))).len)))) goto $$anon_Finally_9409808868480793454;
        {
$$anon_Block_2962505201174496121: (void)(0);
            return 0;
        }

        goto $$anon_Finally_9409808868480793454;
        $$anon_Finally_9409808868480793454: (void)(0);
    }

    uint8_t op = (*(((*(cpu)).bytecode.ptr + (*(cpu)).ip)));
    {
$$anon_Block_16174043371978850487: (void)(0);
        if ((!((op == 60)))) goto $$anon_Else_4220994239978015479;
        {
$$anon_Block_17733290383163642762: (void)(0);
        ...
        {
$$anon_Block_7223447032803900159: (void)(0);
            if ((!((op == 62)))) goto $$anon_Else_7300511195807837772;
            {
...
$$anon_Block_10037347954841597513: (void)(0);
                if ((!((op == 43)))) goto $$anon_Else_7021554769915681659;
                {
...
$$anon_Block_17827319149300544814: (void)(0);
                    if ((!((op == 45)))) goto $$anon_Else_4056369368137485747;
                    {
$$anon_Block_7254980031123428613: (void)(0);
                    ...
                    $$anon_Else_4056369368137485747: (void)(0);
                    {
$$anon_Block_3722109792914517513: (void)(0);
                        if ((!((op == 46)))) goto $$anon_Else_1357782484136285174;
                        {
...
$$anon_Block_7940574305815784789: (void)(0);
                                    ...
                                    goto $$anon_Finally_11132128381755658996;
                                    $$anon_Finally_11132128381755658996: (void)(0);
                                }
                            ...
                            $$anon_Else_10761808952921467351: (void)(0);
                            {
$$anon_Block_9330174281472529096: (void)(0);
                                if ((!(((op == 91) && ((*(((*((&((*(cpu)).memory)))).data + (*((&((*(cpu)).dp))))))) == 0))))) goto $$anon_Else_10433700267734284823;
                                {
...
$$anon_Block_14509286151471457024: (void)(0);
                                    if ((!(((op == 93) && ((*(((*((&((*(cpu)).memory)))).data + (*((&((*(cpu)).dp))))))) != 0))))) goto $$anon_Finally_16425351936864399788;
                                    {
...
$$anon_Block_6338698242424208039: (void)(0);
        if ((!((args.len != 1)))) goto $$anon_Finally_4414800504723860026;
        {
...
$$anon_Block_2835172486924942143: (void)(0);
        if ((!((count < 0)))) goto $$anon_Else_4007520188368829339;
        {
$$anon_Block_14706400349020893043: (void)(0);
        ...
        $$anon_Else_4007520188368829339: (void)(0);
        {
$$anon_Block_4624728463294738839: (void)(0);
            if ((!((count > 2000)))) goto $$anon_Finally_16496529113579175292;
            {
$$anon_Block_14889743372749128975: (void)(0);
            ...
            goto $$anon_Finally_16496529113579175292;
            $$anon_Finally_16496529113579175292: (void)(0);
        }
...
$$anon_Block_11068263668926143820: (void)(0);
        if ((!((!(root__populateBytecode(bytecode, path)))))) goto $$anon_Finally_8815600990787957646;
        {
$$anon_Block_3394227052479976284: (void)(0);
    ...
    $$anon_OptimizedLoop_18303282791192187175: (void)(0);
