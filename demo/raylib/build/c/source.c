...
$$anon_Block_8274098387324605808: (void)(0);
    Array_uint8_t_2_t const str = (Array_uint8_t_2_t){(48 + a), 0};
    return str;
}
...
uint32_t const W = 87;
uint32_t const UP = 265;
uint32_t const S = 83;
uint32_t const DOWN = 264;
...
$$anon_Block_16667537678397990474: (void)(0);
                if (!((b.x < ((WIDTH / 2))))) goto $$anon_Else_11635425079708401102;
                {
...
$$anon_Block_456733118060990777: (void)(0);
                    if (!((b.x > (WIDTH - 5)))) goto $$anon_Finally_3400285954273524107;
                    {
...
$$anon_Block_782751577281147112: (void)(0);
                    if (!((b.y > (HEIGHT - 5)))) goto $$anon_Finally_13312278519466678316;
                    {
...
$$anon_Block_10353734897147312515: (void)(0);
                            if (!((ply.y <= ((HEIGHT - ply.h))))) goto $$anon_Finally_7861373757187157877;
                            {
