...
const_Array_uint8_t_2_t const root__intToChar(uint8_t a)
{
...
int32_t const std__math__random(uint32_t const max)
{
...
jasl_bool const raylib__IsKeyDown(uint32_t const key)
{
...
uint32_t const raylib__W = 87;
uint32_t const raylib__UP = 265;
uint32_t const raylib__S = 83;
uint32_t const raylib__DOWN = 264;
...
$$anon_Block_11132128381755658996: (void)(0);
    ...
    root__Ball ball = (root__Ball){((root__WIDTH / 2) - 10), 120, -5, -5, 10};
...
$$anon_Block_16162674634529531010: (void)(0);
                if ((!((root__checkCollision(ply.x, ball.x, ply.y, ball.y, ply.w, ply.h, ball.r) || root__checkCollision(cpu.x, ball.x, cpu.y, ball.y, cpu.w, cpu.h, ball.r))))) goto $$anon_Finally_4868289067183140247;
                {
$$anon_Block_11635425079708401102: (void)(0);
            ...
            cpu.y = (cpu.y + (((((-(cpu.y)) + (int32_t){ball.y})) * 1) / (int32_t){std__math__random(100)}));
            {
$$anon_Block_18091845151842219177: (void)(0);
                if ((!((ball.x < ((root__WIDTH / 2)))))) goto $$anon_Else_18149526613876181996;
                {
$$anon_Block_16667537678397990474: (void)(0);
                    raylib__DrawCircle((int32_t){ball.x}, (int32_t){ball.y}, ball.r, (Color){255, 255, 255, 255});
                }

                goto $$anon_Finally_3655466039184676393;
                $$anon_Else_18149526613876181996: (void)(0);
                {
$$anon_Block_8935595935260495472: (void)(0);
                    raylib__DrawCircle((int32_t){ball.x}, (int32_t){ball.y}, ball.r, (Color){0, 0, 0, 255});
                }
            ...
            raylib__EndDrawing();
            ball.x = (ball.bx + ball.x);
            ball.y = (ball.by + ball.y);
            {
$$anon_Block_2682622441863699739: (void)(0);
                if ((!((ball.x < 5)))) goto $$anon_Else_15181178797518472446;
                {
$$anon_Block_3400285954273524107: (void)(0);
                    cpu.score = (cpu.score + 1);
                    ball.x = (float){std__math__random((root__WIDTH - (int32_t){ball.r}))};
                    ball.y = (float){std__math__random((root__HEIGHT - (int32_t){ball.r}))};
                    ball.bx = -5;
                }

                goto $$anon_Finally_5315383972134294700;
                $$anon_Else_15181178797518472446: (void)(0);
                {
$$anon_Block_2176238421820118170: (void)(0);
                    if ((!((ball.x > (root__WIDTH - 5))))) goto $$anon_Finally_456733118060990777;
                    {
$$anon_Block_16899537894403953799: (void)(0);
                    ...
                    goto $$anon_Finally_456733118060990777;
                    $$anon_Finally_456733118060990777: (void)(0);
                }

                $$anon_Finally_5315383972134294700: (void)(0);
            }

            {
$$anon_Block_779881660930942984: (void)(0);
                if ((!((ball.y < 5)))) goto $$anon_Else_2525148532737194490;
                {
$$anon_Block_13312278519466678316: (void)(0);
                    ball.by = (-(ball.by));
                }

                goto $$anon_Finally_8984152290478481302;
                $$anon_Else_2525148532737194490: (void)(0);
                {
$$anon_Block_2962505201174496121: (void)(0);
                    if ((!((ball.y > (root__HEIGHT - 5))))) goto $$anon_Finally_782751577281147112;
                    {
$$anon_Block_9409808868480793454: (void)(0);
                        ball.by = (-((ball.by)));
                    }

                    goto $$anon_Finally_782751577281147112;
                    $$anon_Finally_782751577281147112: (void)(0);
                }

                $$anon_Finally_8984152290478481302: (void)(0);
            }

            {
$$anon_Block_10761808952921467351: (void)(0);
                if ((!((raylib__IsKeyDown(87) || raylib__IsKeyDown(265))))) goto $$anon_Else_4220994239978015479;
                {
$$anon_Block_7021554769915681659: (void)(0);
                    {
$$anon_Block_10926936045023930734: (void)(0);
                        if ((!((ply.y >= 5)))) goto $$anon_Finally_7300511195807837772;
                        {
...
$$anon_Block_12490044124299982418: (void)(0);
                    if ((!((raylib__IsKeyDown(83) || raylib__IsKeyDown(264))))) goto $$anon_Finally_7861373757187157877;
                    {
$$anon_Block_17656754144507250444: (void)(0);
                        {
$$anon_Block_1357782484136285174: (void)(0);
                            if ((!((ply.y <= ((root__HEIGHT - ply.h)))))) goto $$anon_Finally_10353734897147312515;
                            {
$$anon_Block_7254980031123428613: (void)(0);
                    ...
                    goto $$anon_Finally_7861373757187157877;
                    $$anon_Finally_7861373757187157877: (void)(0);
                }
        ...
        if ((!(raylib__WindowShouldClose()))) goto $$anon_Loop_13414203536031990682_Start;
    }
