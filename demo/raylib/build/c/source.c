...
$$anon_Block_16162674634529531010: (void)(0);
                if ((!((root__checkCollision(ply.x, b.x, ply.y, b.y, ply.w, ply.h, b.r) || root__checkCollision(cpu.x, b.x, cpu.y, b.y, cpu.w, cpu.h, b.r))))) goto $$anon_Finally_4868289067183140247;
                {
$$anon_Block_11635425079708401102: (void)(0);
                    std__debug__breakpoint();
                    b.bx = (-1 * b.bx);
                }
...
$$anon_Block_18091845151842219177: (void)(0);
                if ((!((b.x < ((root__WIDTH / 2)))))) goto $$anon_Else_18149526613876181996;
                {
...
$$anon_Block_2682622441863699739: (void)(0);
                if ((!((b.x < 5)))) goto $$anon_Else_15181178797518472446;
                {
...
$$anon_Block_2176238421820118170: (void)(0);
                    if ((!((b.x > (root__WIDTH - 5))))) goto $$anon_Finally_456733118060990777;
                    {
...
$$anon_Block_779881660930942984: (void)(0);
                if ((!((b.y < 5)))) goto $$anon_Else_2525148532737194490;
                {
...
$$anon_Block_2962505201174496121: (void)(0);
                    if ((!((b.y > (root__HEIGHT - 5))))) goto $$anon_Finally_782751577281147112;
                    {
